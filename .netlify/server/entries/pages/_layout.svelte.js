...
const css = {
  code: ".app.svelte-830ttg{display:flex;flex-direction:column;min-height:100vh}main.svelte-830ttg{flex:1;display:flex;flex-direction:column;padding:1rem;width:100%;max-width:64rem;margin:0 auto;box-sizing:border-box}@media(min-width: 480px){main.svelte-830ttg{padding:12px 40px}}",
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(ThemeContext, "ThemeContext").$$render($$result, {}, {}, {
    default: () => {
      return `<div class="${"app svelte-830ttg"}">${validate_component(Header, "Header").$$render($$result, {}, {}, {})}
			<main class="${"svelte-830ttg"}">${slots.default ? slots.default({}) : ``}</main>
